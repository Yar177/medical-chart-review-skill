...
---
*Audit performed against current ICD-10-CM Official Guidelines and applicable CMS HCC model. Final determinations require a credentialed coder (CRC/CCS).*

*For NLP-assisted HCC audits with model-version metadata, MEAT evidence capture, hierarchy application, and reviewer-override feedback to the failure-mode catalog, see `hcc-nlp/templates/hcc-audit-nlp.md` in the same repo.*
