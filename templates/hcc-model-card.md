...
Parallel to [`per-measure-model-card.md`](per-measure-model-card.md) (HEDIS). Same philosophy, HCC-specific fields.
...
- Acceptable provider roles per [`../references/hcc/date-of-service.md`](../references/hcc/date-of-service.md)
...
- Methodology summary (see [`../references/hcc/evaluation-and-validation.md`](../references/hcc/evaluation-and-validation.md))
...
Reference the failure-mode catalog. Summarize the top 3-5 known failure modes, the regression fixtures that cover them (see [`../references/hcc/test-fixtures/`](../references/hcc/test-fixtures/)), and mitigation status.
...
See [`../references/hcc/compliance-and-enforcement.md`](../references/hcc/compliance-and-enforcement.md).
...
- [`per-measure-model-card.md`](per-measure-model-card.md) - parallel HEDIS template
- [`hcc-audit.md`](hcc-audit.md) - chart-level audit worksheet that pairs with this model card at runtime
- [`../references/hcc/README.md`](../references/hcc/README.md) - HCC NLP enablement directory
- [`../references/hcc/compliance-and-enforcement.md`](../references/hcc/compliance-and-enforcement.md) - regulatory context
- [`../references/hcc/evaluation-and-validation.md`](../references/hcc/evaluation-and-validation.md) - evaluation methodology
- [`../references/hcc/model-versions.md`](../references/hcc/model-versions.md) - V28 / V24 / HHS-HCC pinning
- [`../references/hcc/cards/`](../references/hcc/cards/) - per-HCC cards
