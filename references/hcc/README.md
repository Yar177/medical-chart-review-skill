...
The auditor-facing summary lives in [`../coding-icd10-hcc.md`](../coding-icd10-hcc.md). The files here tell you **how to extract HCCs reliably** at scale, including the failure modes that drive RADV findings and FCA enforcement.
...
| [`../../templates/hcc-audit.md`](../../templates/hcc-audit.md) | Auditor worksheet, with NLP-assisted fields |
...
- [`../coding-icd10-hcc.md`](../coding-icd10-hcc.md) - auditor-facing HCC reference
- [`../hedis/README.md`](../hedis/README.md) - parallel structure for HEDIS NLP
- [`../../templates/hcc-audit.md`](../../templates/hcc-audit.md) - human-audit worksheet with NLP-assisted fields
