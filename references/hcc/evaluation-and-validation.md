...
The HEDIS NLP evaluation reference is [`../nlp/evaluation-and-validation.md`](../nlp/evaluation-and-validation.md). The general structure (span / document / patient-level, IAA, drift) carries over; HCC-specific extensions are below.
...
- [`../nlp/evaluation-and-validation.md`](../nlp/evaluation-and-validation.md) - shared HEDIS evaluation framework
