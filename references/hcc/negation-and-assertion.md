...
The cross-cutting HEDIS framework lives in [`../nlp/negation-and-assertion.md`](../nlp/negation-and-assertion.md). This file extends it for HCC. Use both.
...
The HEDIS library landscape in [`../nlp/negation-and-assertion.md`](../nlp/negation-and-assertion.md) applies here. Specifically for HCC:
...
- [`../nlp/negation-and-assertion.md`](../nlp/negation-and-assertion.md) - shared HEDIS framework
