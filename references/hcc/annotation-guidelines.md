...
The HEDIS annotation guidelines live in [`../nlp/annotation-guidelines.md`](../nlp/annotation-guidelines.md). HCC-specific schema and rules are below.
...
- [`../nlp/annotation-guidelines.md`](../nlp/annotation-guidelines.md) - shared HEDIS annotation guidance
